...
; ask the user for boss floor number
CALL 03BAH ; RDKBD

; convert the value to bit configuration
MOV E, A
DCR E
MVI A, 01H
CONVERTLOOP: NOP
...
MOV A, L
CMP C
; RDLIFTBUTTON if the destination floor that is the boss floor has been reached
JZ RDLIFTBUTTON
